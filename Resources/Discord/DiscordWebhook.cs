...
{
    private static string url = "https://discord.com/api/webhooks/788294914726952970/9nPxboYJD-vI8O8UjWmQMDXMaeBdWBl-U8FFX39NNOXqWOyWCaAA3p51qktXeMO4HRN_";// ——€À ¿ Õ¿ ƒ»— Œ–ƒ ¬≈¡’” 

     public static   string send(string msgBody)
    {
